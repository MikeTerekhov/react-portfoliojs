        ...
        <main className='bg-white px-10 md:px-20 lg:px-40 dark:bg-gray-900 min-h-screen'>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className='text-center shadow-lg p-10 rounded-xl dark:bg-white'>
              ...
              <h3 className='text-black text-xl font-medium pt-8 pb-2 font-["0xProtoNerdFont"]'>Smart PDF Analyzer</h3>
            </div>
            ...
            <div className='text-center shadow-lg p-10 rounded-xl dark:bg-white'>
              ...
              <h3 className='text-black text-xl font-medium pt-8 pb-2 font-["0xProtoNerdFont"]'>Autonomous Goose-Chaser</h3>
            </div>
            ...
            <div className='text-center shadow-lg p-10 rounded-xl dark:bg-white'>
              ...
              <h3 className='text-black text-xl font-medium pt-8 pb-2 font-["0xProtoNerdFont"]'>Swift Emoji Memory Card Game</h3>
            </div>
          </div>
        </main>
    </>
