      ...
      <div className={darkMode ? "dark" : ""}>
        <main className='bg-white px-10 md:px-20 lg:px-40 dark:bg-gray-900 min-h-screen'>
          <div className='text-center shadow-lg p-10 rounded-xl my-10 dark:bg-white'>
            ...
            <p className='text-black font-["0xProtoNerdFont"] text-xl'>
            ...
            <h3 className='text-black text-4xl font-medium pt-8 pb-2 font-["0xProtoNerdFont"] text-left'>Roles & Responsibilities:</h3>

            <p className='text-black font-["0xProtoNerdFont"] text-xl text-left'>
            ...
            <h3 className='text-black text-4xl font-medium pt-8 pb-2 font-["0xProtoNerdFont"] text-left'>Accomplishments:</h3>

            <p className='text-black font-["0xProtoNerdFont"] text-2xl text-center'>
            ...
            <p className='text-black font-["0xProtoNerdFont"] text-2xl text-center pt-8'>
              NX
            </p>
            <p className='text-black font-["0xProtoNerdFont"] text-xl text-left'>
