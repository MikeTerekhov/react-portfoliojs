    ...
    <div className={darkMode ? "dark" : ""}>
      <div className='bg-white px-10 md:px-20 lg:px-40 dark:bg-gray-900'> 
        <section>
          ...
          <div>           
            <h3 style={{ textAlign: 'center' }} className = "text-7xl py-1 dark:text-white font-burtons">Goose Chaser</h3>
          </div>
          <div className='gap-10'>
            <div className='text-center shadow-lg p-10 rounded-xl my-10 dark:bg-white'>
                ...
                <h3 className='text-4xl font-medium pt-8 pb-2 font-burtons text-left'> Initial Software Design - Simple CNN:</h3>
                <p className='font-burtons text-xl'>
                ...
                <h3 className='text-4xl font-medium pt-8 pb-2 font-burtons text-left'> Final Software Design - YOLOv5 Model:</h3>
                <p className='font-burtons text-xl text-left'>
                ...
                <div style={{ padding: '20px' }}>
                <h3 className='text-4xl font-medium pt-8 pb-2 font-burtons text-left'> Training Process:</h3>
                <p className='font-burtons text-xl text-left'>
                ...
                <div style={{ padding: '20px' }}>
                <h3 className='text-4xl font-medium pt-8 pb-2 font-burtons text-left'> Model Results with 20 training images trained for 250 epochs:</h3>
                ...
                <div style={{ padding: '20px' }}>
                <h3 className='text-4xl font-medium pt-8 pb-2 font-burtons text-left'> Our Final Drone:</h3>
