...
function DocRead() {
  return (
    ...
    <div className='bg-gray-900 px-10 md:px-20 lg:px-40'>
           <div>
            <h3 style={{ textAlign: 'center' }} className="text-white text-7xl py-8 px-4 font-droidMono">PDF Analyzer</h3>
          </div>
          <div className='gap-10'>
            <div className='bg-white text-center shadow-lg p-10 rounded-xl my-10'>
                ...
                <h3 className='text-black text-4xl font-medium pt-8 pb-2 font-droidMono text-left'> APIs:</h3>
                <p className='text-black font-droidMono text-xl'>
                ...
                <div style={{ padding: '20px' }}>
                    <p className='text-black font-droidMono text-left text-2xl'>
                    Upload:
                    </p>
                ...
                <h3 className='text-black text-4xl font-medium pt-8 pb-2 font-droidMono text-left'> Mongo DB: </h3>
                <p className='text-black font-droidMono text-left text-xl'>
