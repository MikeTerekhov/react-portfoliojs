        ...
        <section>
          ...
          <div className='gap-10'>
            <div className='text-center shadow-lg p-10 rounded-xl my-10 dark:bg-white'>
                ...
                <h3 className='text-4xl font-medium pt-8 pb-2 font-burtons text-left'> CNN parameter & architecture tuning:</h3>
                ...
                <h1 className='font-burtons text-3xl' style={{ padding: '20px' }}>
                ...
                <p className='font-burtons text-left text-xl' style={{ padding: '20px' }}>
                ...
                <div style={{ padding: '20px' }}>
                <h3 className='text-4xl font-medium pt-8 pb-2 font-burtons text-left'> Q-learning results:</h3>
                <div style={{ padding: '20px' }}>
                ...
                <div style={{ padding: '20px' }}>
                <h3 className='text-4xl font-medium pt-8 pb-2 font-burtons text-left'> Linear Approximation Q-learning results:</h3>
                <div style={{ padding: '20px' }}>
