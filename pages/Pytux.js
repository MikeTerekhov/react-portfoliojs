...
function Pytux() {
  return (
    ...
    <div className='bg-gray-900 px-10 md:px-20 lg:px-40'>
           <div>
            <h3 style={{ textAlign: 'center' }} className="text-white text-7xl py-8 px-4 font-burtons">Self-Driving Kart</h3>
          </div>
          <div className='gap-10'>
            <div className='bg-white text-center shadow-lg p-10 rounded-xl my-10'>
                ...
                <h3 className='text-black text-4xl font-medium pt-8 pb-2 font-droidMono text-left'> CNN parameter & architecture tuning:</h3>
                <Image src={nn_test} width={1500} height={1500} className='mx-auto'/>
                </div>
                <div style={{ padding: '20px' }}>
                <h3 className='text-black text-4xl font-medium pt-8 pb-2 font-droidMono text-left'> Altering dataset size and training epochs for CNN:</h3>
                ...
                <p className='text-black font-droidMono text-left text-xl'>
                ...
                <div style={{ padding: '20px' }}>
                <h3 className='text-black text-4xl font-medium pt-8 pb-2 font-burtons text-left'> Reinforcement Learning:</h3>
                <p className='text-black font-droidMono text-xl'>
                ...
                <h1 className='text-black font-droidMono text-3xl'>
                ...
                <h1 className='text-black font-droidMono text-3xl' style={{ padding: '20px' }}>
                ...
                <p className='text-black font-droidMono text-left text-xl' style={{ padding: '20px' }}>
                ...
                <div style={{ padding: '20px' }}>
                <h3 className='text-black text-4xl font-medium pt-8 pb-2 font-droidMono text-left'> Q-learning results:</h3>
                <div style={{ padding: '20px' }}>
                ...
                <div style={{ padding: '20px' }}>
                <h3 className='text-black text-4xl font-medium pt-8 pb-2 font-droidMono text-left'> Linear Approximation Q-learning results:</h3>
                <div style={{ padding: '20px' }}>
