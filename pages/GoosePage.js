...
function GoosePage() {
  return (
    ...
    <div className='bg-gray-900 px-10 md:px-20 lg:px-40'>
           <div>
            <h3 style={{ textAlign: 'center' }} className="text-white text-7xl py-8 px-4 font-droidMono">Goose Chaser</h3>
          </div>
          <div className='gap-10'>
            <div className='bg-white text-center shadow-lg p-10 rounded-xl my-10'>
                ...
                <h3 className='text-black text-4xl font-medium pt-8 pb-2 font-droidMono text-left'> Initial Software Design - Simple CNN:</h3>
                <p className='text-black font-droidMono text-xl'>
                ...
                <h3 className='text-black text-4xl font-medium pt-8 pb-2 font-droidMono text-left'> Final Software Design - YOLOv5 Model:</h3>
                <p className='text-black font-droidMono text-xl text-left'>
                ...
                <div style={{ padding: '20px' }}>
                <h3 className='text-black text-4xl font-medium pt-8 pb-2 font-droidMono text-left'> Training Process:</h3>
                <p className='text-black font-droidMono text-xl text-left'>
                ...
                <div style={{ padding: '20px' }}>
                <h3 className='text-black text-4xl font-medium pt-8 pb-2 font-droidMono text-left'> Model Results with 20 training images trained for 250 epochs:</h3>
                ...
                <div style={{ padding: '20px' }}>
                <h3 className='text-black text-4xl font-medium pt-8 pb-2 font-droidMono text-left'> Our Final Drone:</h3>
